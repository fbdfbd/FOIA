...
namespace OneMoreSpoon.Game.Definitions
{
    ...
    public sealed class SO_OutputRuleDefinition : ScriptableObject
    {
        ...
        [SerializeField] private List<string> requiredDiscoveredSubstanceIds = new();
        ...
        public IReadOnlyList<string> RequiredDiscoveredSubstanceIds => requiredDiscoveredSubstanceIds;
